...
class CopyFormJelekongOut extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final postPengeluaran =
        ref.watch(pengeluaranListProvider).where((element) => false);
            ...
            child: Column(
              children: [
                ...
                SizedBox(
                  ...
                  child: Column(
                    children: const [
                      // ref.watch(pengeluaranListProvider).map((e) => ListView.builder(
                      //   itemBuilder: (context, ref){
                      //   return Row(children: Text(e.tanggal),
                      //   );
                      // }
                      // ),
                      // ),
